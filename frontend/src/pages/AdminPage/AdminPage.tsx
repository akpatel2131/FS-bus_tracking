...
export function AdminPage() {
  ...
  const set =
    (f: keyof FormState) => (e: React.ChangeEvent<HTMLInputElement>) => {
  ...
  const validate = (): boolean => {
    ...
    if (isNaN(seats) || seats < 1 || seats > 100)
      errs.totalSeats = "Seats must be 1–100.";
    ...
    <div className="page-wrap admin-page">
      <div className="container">
        <PageHeader
          ...
          action={<span className="badge badge-info">⚙ {user?.name}</span>}
        />
          ...
          <div className="create-form">
            ...
            >
              ...
              <div className="form-group">
                ...
                <input
                  className={`form-input${errors.busName ? " is-error" : ""}`}
                  placeholder="e.g. Sharma Travels Express"
                  value={form.busName}
                  onChange={set("busName")}
                />
                {errors.busName && (
                  <span className="form-error">⚠ {errors.busName}</span>
                )}
              </div>
              ...
              <div className="grid-2" style={{ gap: 10 }}>
                <div className="form-group">
                  ...
                  <input
                    className={`form-input${errors.source ? " is-error" : ""}`}
                    placeholder="Mumbai"
                    value={form.source}
                    onChange={set("source")}
                  />
                ...
                <div className="form-group">
                  ...
                  <input
                    className={`form-input${errors.destination ? " is-error" : ""}`}
                    placeholder="Pune"
              ...
              <div className="grid-2" style={{ gap: 10 }}>
                <div className="form-group">
                  ...
                  <input
                    type="number"
                    className={`form-input${errors.totalSeats ? " is-error" : ""}`}
                    min={1}
                    max={100}
              ...
              <>
                ...
                {!tripsLoading && !tripsError && trips.length === 0 && (
                  <EmptyState
                    icon="🚌"
                    title="No trips yet"
                    desc="Create your first trip using the form."
                  />
                )}
                    ...
                    {trips.map((trip) => (
                      <div key={trip._id} className="admin-trip-row">
                        ...
                        <div className="admin-trip-row__actions">
                          <span
                            className={`badge ${trip.availableSeats === 0 ? "badge-failed" : "badge-confirmed"}`}
                          >
